...
- `/wm-version` → Select a workflow and show its version history.
- `/wm-version <workflow name>` → Load version history for the named workflow directly.
