# Watermelon Tutorial #02 — bk-import: Convert Any Resource into a Workflow

## 0. What this tutorial shows

A GitHub repo, a local skill, an external URL — one `/bk-import` command is all it takes to:
...
Reads `~/.claude/skills/bk-design/SKILL.md` and converts the skill's execution flow into a Watermelon workflow.
...
```
User: /bk-import yamadashy/repomix
